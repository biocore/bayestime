...
```{r, fig.height = 4, fig.width=6}
plot_fpc_on_mean_curve(output = model_output, pc_idx = 1, original = T)
plot_fpc_on_mean_curve(output = model_output, pc_idx = 2, original = F)
```
...
```{r, fig.height = 4, fig.width=6}
plot_fpc_boxplot(output = model_output, pc_idx = 1, group_name = 'diet_3',
